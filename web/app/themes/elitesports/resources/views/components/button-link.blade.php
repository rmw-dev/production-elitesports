...
@php
    ...
    $base = 'button-link inline-flex min-h-12 max-w-full items-center justify-center gap-2 rounded-full border px-5 py-3 text-center text-sm leading-tight font-semibold tracking-[0.08em] uppercase transition duration-300 ease-in-out sm:whitespace-nowrap';
